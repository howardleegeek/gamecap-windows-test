...
[GameCap-Full-Setup-v0.1.9.exe](https://github.com/howardleegeek/gamecap-windows-test/releases/download/v0.1.9/GameCap-Full-Setup-v0.1.9.exe)
...
This version bundles OBS Studio portable directly into GameCap. Testers do not need to install OBS separately. Minecraft itself is not bundled because it requires Microsoft/Mojang licensing and user login, but GameCap opens Minecraft Launcher and installs the Fabric mod jars.

Installer SHA-256:

```text
19de383220ff47f10e1feba9639d78715a1bc47d662c88ddeb1e94082da98225
```
...
1. Run `GameCap-Full-Setup-v0.1.9.exe`.
